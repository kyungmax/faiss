...
class SearchParametersHNSWAdaptiveLight(SearchParametersHNSW):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    enable_stop = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_enable_stop_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_enable_stop_set)
    efMax = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_efMax_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_efMax_set)
    tmin_pops = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_tmin_pops_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_tmin_pops_set)
    early_stop_ratio = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_early_stop_ratio_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_early_stop_ratio_set)
    super_easy_gamma_ratio = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_super_easy_gamma_ratio_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_super_easy_gamma_ratio_set)
    mid_easy_upper_gamma_ratio = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_mid_easy_upper_gamma_ratio_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_mid_easy_upper_gamma_ratio_set)
    paper_bucket_mode = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_paper_bucket_mode_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_paper_bucket_mode_set)
    paper_bucket_count = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_paper_bucket_count_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_paper_bucket_count_set)
    bucket_gamma_ratio_0 = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_0_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_0_set)
    bucket_gamma_ratio_1 = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_1_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_1_set)
    bucket_gamma_ratio_2 = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_2_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_2_set)
    bucket_gamma_ratio_3 = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_3_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_3_set)
    bucket_gamma_ratio_4 = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_4_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_4_set)
    bucket_gamma_ratio_5 = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_5_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_5_set)
    bucket_gamma_ratio_6 = property(_swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_6_get, _swigfaiss.SearchParametersHNSWAdaptiveLight_bucket_gamma_ratio_6_set)
    __swig_destroy__ = _swigfaiss.delete_SearchParametersHNSWAdaptiveLight

    def __init__(self):
        _swigfaiss.SearchParametersHNSWAdaptiveLight_swiginit(self, _swigfaiss.new_SearchParametersHNSWAdaptiveLight())

# Register SearchParametersHNSWAdaptiveLight in _swigfaiss:
_swigfaiss.SearchParametersHNSWAdaptiveLight_swigregister(SearchParametersHNSWAdaptiveLight)
class HNSW(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def search_adaptive_light(self, qdis, index, res, vt, params=None):
        return _swigfaiss.HNSW_search_adaptive_light(self, qdis, index, res, vt, params)

    def search_first_target_hit_step(self, qdis, index, vt, k, ef_before, switch_pop, switch_full_pop, ef_after, target_labels, target_label_count, target_hit_count, params=None):
        return _swigfaiss.HNSW_search_first_target_hit_step(self, qdis, index, vt, k, ef_before, switch_pop, switch_full_pop, ef_after, target_labels, target_label_count, target_hit_count, params)
...
class HNSWTargetHitStats(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    first_target_hit_step = property(_swigfaiss.HNSWTargetHitStats_first_target_hit_step_get, _swigfaiss.HNSWTargetHitStats_first_target_hit_step_set)
    target_hit_count = property(_swigfaiss.HNSWTargetHitStats_target_hit_count_get, _swigfaiss.HNSWTargetHitStats_target_hit_count_set)
    achieved_hit_count = property(_swigfaiss.HNSWTargetHitStats_achieved_hit_count_get, _swigfaiss.HNSWTargetHitStats_achieved_hit_count_set)
    reached_target = property(_swigfaiss.HNSWTargetHitStats_reached_target_get, _swigfaiss.HNSWTargetHitStats_reached_target_set)
    search_stats = property(_swigfaiss.HNSWTargetHitStats_search_stats_get, _swigfaiss.HNSWTargetHitStats_search_stats_set)

    def __init__(self):
        _swigfaiss.HNSWTargetHitStats_swiginit(self, _swigfaiss.new_HNSWTargetHitStats())
    __swig_destroy__ = _swigfaiss.delete_HNSWTargetHitStats

# Register HNSWTargetHitStats in _swigfaiss:
_swigfaiss.HNSWTargetHitStats_swigregister(HNSWTargetHitStats)
...
class IndexHNSW(Index):
    ...
    def knn_query_adaptive_light(self, n, x, k, distances, labels, params=None):
        return _swigfaiss.IndexHNSW_knn_query_adaptive_light(self, n, x, k, distances, labels, params)

    def knn_query_hide_node(self, n, x, hide_labels, k, distances, labels, params=None):
        return _swigfaiss.IndexHNSW_knn_query_hide_node(self, n, x, hide_labels, k, distances, labels, params)

    def compute_internal_lids(self, n, ids, k_lid, lids, params=None):
        return _swigfaiss.IndexHNSW_compute_internal_lids(self, n, ids, k_lid, lids, params)

    def search_layer0_trace(self, n, x, k, ef, hide_labels, max_steps, step_counts, truncated_flags, distance_counts, closest_dists, node_labels, rs_sizes, rs_sizes_after, is_full_pop_after, full_pop_counts_after, popped_degrees, unvisited_counts, accepted_counts, runtime_accepted_rates, runtime_cfrs, runtime_smoothed_cfrs, internal_dists, popped_query_dists, furthest_dists, best_dists, top_k_dists, ef_half_dists, ef_quarter_dists, sqrt_ef_dists, top_2k_dists, top_3k_dists, params=None):
        return _swigfaiss.IndexHNSW_search_layer0_trace(self, n, x, k, ef, hide_labels, max_steps, step_counts, truncated_flags, distance_counts, closest_dists, node_labels, rs_sizes, rs_sizes_after, is_full_pop_after, full_pop_counts_after, popped_degrees, unvisited_counts, accepted_counts, runtime_accepted_rates, runtime_cfrs, runtime_smoothed_cfrs, internal_dists, popped_query_dists, furthest_dists, best_dists, top_k_dists, ef_half_dists, ef_quarter_dists, sqrt_ef_dists, top_2k_dists, top_3k_dists, params)

    def search_layer0_chr_summary(self, n, x, k, ef, hide_labels, full_pop_counts, window_obs_counts, usable_flags, distance_counts, mean_smoothed_cfrs, closest_dists, params=None):
        return _swigfaiss.IndexHNSW_search_layer0_chr_summary(self, n, x, k, ef, hide_labels, full_pop_counts, window_obs_counts, usable_flags, distance_counts, mean_smoothed_cfrs, closest_dists, params)

    def knn_query_beam_width_first_target_hit_step(self, n, x, target_k, target_labels, target_hits, k, ef_before, switch_pop, switch_full_pop, ef_after, first_steps, reached_flags, achieved_hits, params=None):
        return _swigfaiss.IndexHNSW_knn_query_beam_width_first_target_hit_step(self, n, x, target_k, target_labels, target_hits, k, ef_before, switch_pop, switch_full_pop, ef_after, first_steps, reached_flags, achieved_hits, params)
